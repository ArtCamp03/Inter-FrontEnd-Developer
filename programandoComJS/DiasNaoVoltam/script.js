...
let n = 7 //parseInt(lines.shift());
/*
var sitacao = ['l','i','f','e','s','n','o','t','a','p','r','o','b','l','e','m','t','o','b','e','s','o','l','v','e','d'];
*/
var text = 'Life is not a problem to be solved, but a reality to be experienced';
